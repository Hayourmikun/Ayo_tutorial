...
mtext(expression(paste("Phylogenetic tree of ", italic("Anopheles stephensi")," from the combined locations")),
...
q <- ggtree(nj_tree) +
  geom_tiplab(size=1.2, align=FALSE, linesize=.5)  +
  labs(caption = expression(paste("Phylogenetic tree of ", italic("Anopheles stephensi"), "from the combined locations"))) +
